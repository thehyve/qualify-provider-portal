			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<g:sortableColumn property="threescale_id" title="${message(code: 'webservice.threescale_id.label', default: 'Threescaleid')}" />
				...
				<g:each in="${webserviceInstanceList}" status="i" var="webserviceInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="edit" id="${webserviceInstance.id}">${fieldValue(bean: webserviceInstance, field: "name")}</g:link></td>
