...
<div class='s2ui_center'>
  ...
  <div id="loginFormContainer" style='display:none'
       title="${message(code: 'spring.security.ui.login.signin')}">
    <g:form controller='j_spring_security_check' name="loginForm"
            autocomplete='off'>
      ...
      <input class='login' type="password" name="j_password" id="password"
             size="20"/>
      ...
      <g:link controller='register'><g:message
