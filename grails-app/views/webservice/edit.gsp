...
<html>
	...
	<body>
		<div id="edit-webservice" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:webserviceInstance, action:'update']" class="form-horizontal" role="form" method="PUT">
				<g:hiddenField name="version" value="${webserviceInstance?.version}" />
				<g:render template="form"/>

				  <div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<g:actionSubmit class="save" action="update" class="btn btn-default"  value="${message(code: 'default.button.update.label', default: 'Update')}" />
					</div>
				  </div>
			</g:form>
		</div>
