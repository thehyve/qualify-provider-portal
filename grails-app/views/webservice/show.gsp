	...
	<body>
		...
		<div id="show-webservice" class="content scaffold-show" role="main">
			...
			<ol class="property-list webservice">
				...
				<li class="fieldcontain">
					<span id="threescale_id-label" class="property-label"><g:message code="webservice.threescale_id.label" default="Threescaleid" /></span>
					
						<span class="property-value" aria-labelledby="threescale_id-label"><g:fieldValue bean="${webserviceInstance}" field="threescale_id"/></span>
				...
				<li class="fieldcontain">
					<span id="users-label" class="property-label"><g:message code="webservice.users.label" default="Users" /></span>
			...
			<g:form url="[resource:webserviceInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${webserviceInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
